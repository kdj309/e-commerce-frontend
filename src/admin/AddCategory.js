...
export default function AddCategory() {
    ...
    return (
        <>
            <Base className='container p-4 bg-info' title='Create category' description='You can create multiple category'>
                <div className="row">
                    <div className="col-md-8 offset-md-2 bg-white text-dark p-4">
                        {success ? <Alert alerttype="success" msg="Category created successfully" /> : error ? <Alert alerttype='danger' msg={errormsg} /> : null}
